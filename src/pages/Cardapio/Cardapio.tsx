...
export default function Cardapio() {
  ...
  function changeCardModalRight(ev: React.MouseEvent) {
    ev.preventDefault();
  ...
  function changeCardModalLeft(ev: React.MouseEvent) {
    ev.preventDefault();
      ...
      <main>
        <div id="mainCardapioContainer">
          ...
          <div id="imgCardapioContainer">
            ...
            <div id="imgContainerCard" onClick={() => openModal(imgCard)}>
